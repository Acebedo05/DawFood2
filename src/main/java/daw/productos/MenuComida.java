...
public class MenuComida {
    ...
    public void añadirProductoAComidas() {
        ...
        // Escribir los detalles del nuevo producto en el archivo comidas.csv.
    ...
    private void escribirProductoEnArchivoCSV(Producto producto) {
        String rutaArchivo = "Comidas.csv";
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(rutaArchivo, true))) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al escribir en el archivo Comidas.csv.");
        }
    }

    // Método para verificar si ya existe un producto con el mismo nombre.
    private boolean nombreProductoExistente(String nombre) {
        // Iterar sobre la lista de comidas para verificar si existe un producto con el mismo nombre.
        for (Producto producto : comidas) {
    ...
    // Método para borrar producto de comidas.
    public void borrarProducto(String nombreProducto) {
        ...
        Iterator<Producto> iterator = comidas.iterator();
        while (iterator.hasNext()) {
            ...
            if (producto.getNombre().equalsIgnoreCase(nombreProducto)) {
                ...
                iterator.remove();
                // Eliminar el producto del archivo comidas.csv
    ...
    // Método para eliminar un producto del archivo comidas.csv
    private void eliminarProductoDelArchivo(Producto nombreProducto) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(archivo))) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al actualizar el archivo Comidas.csv.");
            return;
        }
    }
    ...
    // Método para editar el producto en el archivo comidas.csv
